...
严禁包含任何 Markdown 标记、严禁输出任何换行符或多余解释文本、严禁输出思考过程：
 ...
 * 注意：部分模型（如 GLM-4.7-Flash）有思维链功能，会先在 reasoning_content
 * 中输出推理过程，再在 content 中输出正式结果。500 token 会被推理过程吃光，
 * 导致 content 为空且 finish_reason="length"。提高到 2000 给足空间。
 */
export const GALGAME_MAX_TOKENS = 2000;
